...
public class ClientService implements Serializable {
    ...
    public List<Client> getClientsByCourse(Integer course) {
        return clientRepository.findByCourse(course);
    }
    
    public List<Client> getClientsBySpeciality(String speciality) {
