...
public class ClientConverter implements Converter<Client> {
    ...
    public Client getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            ...
            logger.info("Converted string '" + value + "' to Client: " + (client != null ? client.getNameClient() : "null"));
            return curriculum;
    ...
    public String getAsString(FacesContext context, UIComponent component, Client client) {
        ...
        try {
            ...
            if (client.getId() == null) {
                logger.warning("Client с null ID: " + client.getNameClient());
                return "";
            }
            
            String result = client.getId().toString();
            logger.info("Конвертирован клиент'" + curriculum.getNameClient() + "' в строку: " + result);
            return result;
        } catch (Exception e) {
